...
export function QualityIndicator({ quality, pixelSize }: QualityIndicatorProps) {
  ...
  return (
    <div className="absolute top-4 right-4 bg-black/70 backdrop-blur-sm rounded-lg px-4 py-2 text-white">
      <div className="flex items-center gap-3">
        <div className="text-right">
          <div className="text-xs text-zinc-400 uppercase tracking-wide">Quality</div>
